...
class ReporteMatriculaController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $matriculados = $this->getMatriculados($request, auth()->user()->us_codigo);
    ...
    public function generarPdf(Request $request)
    {
        ...
        $matriculados = $this->getMatriculados($request, $usuario->us_codigo);
    ...
    private function getMatriculados($request, int $usuario)
    {
        ...
        return ItMatricula::whereDate('ma_fecha', '>=', $fechaInicial)
            ...
            ->where('us_codigo_create', $usuario)
