...
use App\Models\Sede1\Cliente as ClienteSede1;
use App\Models\Sede1\Evaluacion as Sede1Evaluacion;
use App\Models\Sede1\Inscripcion as Sede1Inscripcion;
use App\Models\Sede1\Pago as Sede1Pago;
use App\Models\Sede2\Cliente;
use App\Models\Sede2\Evaluacion;
use App\Models\Sede2\Inscripcion;
use App\Models\Sede2\Pago;
use Carbon\Carbon;
use DateTime;
...
class Sede2Service
{
    ...
    {
        $clientes = ClienteSede1::where('ci', $matricula->estudiante->es_documento)
        ...
        if ($clientes) {
            $inscripcion = Sede1Inscripcion::where('id_cliente', $clientes->id_cliente)
            ...
            if ($inscripcion) {
                ...
                $evaluacion = Sede1Evaluacion::where('id_inscripcion', $inscripcion->id_inscripcion)->get();
                foreach ($evaluacion as $eval) {
                    $eval->estado = 0;
                    $eval->save();
                }

                $pago = Sede1Pago::where('id_inscripcion', $inscripcion->id_inscripcion)->first();
                $pago->estado = 'IN';
                $pago->save();
            }
        }
    ...
    protected function procesarMatricula(ItMatricula $matricula)
    {
        ...
        if (isset($matricula->estudiante->es_foto) && $matricula->estudiante->es_foto !== "") {
            ...
            $filepath = "/home/bnpupehn/inscripcionaromacentral.padbolivia.com/upload/".$imageName;//seg path
