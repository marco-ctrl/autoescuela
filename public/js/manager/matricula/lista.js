$(document).ready(function () {
    ...
    $("#btnAgregarCurso").click(function (e) {
        ...
        $.ajax({
            ...
            url:
                BASEURL +
                "/manager_matricula/agregar-curso/" +
                codigoMatricula,
            headers: {
                Accept: "application/json",
    ...
    $("#btnEditarMatricula").click(function (e) {
        ...
        $.ajax({
            type: "PUT",
            url: BASEURL + "/manager_matricula/edit/" + codigoMatricula,
            headers: {
                Accept: "application/json",
                Authorization: "Bearer " + token, // Pasar el token como parte de la cabecera de autorización
            },
    ...
    $("#btnAgregarEvaluacion").click(function (e) {
        ...
        $.ajax({
            ...
            url:
                BASEURL +
                "/manager_matricula/agregar-evaluacion/" +
                codigoMatricula,
            headers: {
                Accept: "application/json",
                Authorization: "Bearer " + token, // Pasar el token como parte de la cabecera de autorización
    ...
    function listarCategoria(edad) {
        $.ajax({
            url: BASEURL + "/manager_categoria/" + edad,
            type: "get",
            dataType: "json",
            success: function (response) {
