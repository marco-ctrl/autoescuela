        ...
        <div class="card-body">
            <div class="d-flex flex-row bd-highlight mb-3">
                <div class="p-2 bd-highlight">
                    <form id="form" class="form-inline" method="POST" action="{{ route('admin.pdf.reporte-matriculados') }}" target="_blank">
...
@endsection
@section('scripts')
    <script src="{{ asset('js/admin/reportes/reporteMatriculados.js') }}"></script>
@endsection
