    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                <label for="es_expedicion">Exp*</label>
...
<div class="col-md-6 col-sm-12 col-lg-4">
    ...
    <div class="form-group">
        ...
        <textarea rows="2" class="form-control" id="es_direccion" name="es_direccion" placeholder="Ingresar Direccion" required></textarea>
    </div>
    <div class="form-group">
        <label for="es_oberservacion">Observacion</label>
        <textarea rows="2" class="form-control" id="es_observacion" name="es_observacion" placeholder="Ingresar Observacion"></textarea>
    </div>
    <div class="form-group">
