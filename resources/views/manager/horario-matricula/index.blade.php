...
@section('content')
    @if ($matricula->cu_codigo == null)
        <div class="text-center">
            ...
            <a href="{{ route('manager.matriculas.index') }}" class="btn btn-primary mt-5">&larr; Volver Listado de
                Matriculados</a>
        </div>
    @else
        <div class="card">
...
@section('scripts')
    ...
    <script src="{{ asset('js/manager/horario_matricula/form.js') }}"></script>
    <script src="{{ asset('js/manager/horario_matricula/agregarHorasExtra.js') }}"></script>
