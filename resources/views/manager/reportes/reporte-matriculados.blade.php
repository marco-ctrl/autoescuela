...
@section('content')
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Reporte Matriculados</h6>
        </div>
        <div class="card-body">
            <div class="d-flex flex-row bd-highlight mb-3">
                <div class="p-2 bd-highlight">
                    <form id="form" class="form-inline" method="POST" action="{{ route('manager.pdf.reporte-matriculados') }}" target="_blank">
...
@endsection
@section('scripts')
    <script src="{{ asset('js/manager/reportes/reporteMatriculados.js') }}"></script>
@endsection
