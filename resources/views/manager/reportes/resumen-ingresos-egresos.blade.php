        ...
        <div class="card-body">
            <div class="d-flex flex-row bd-highlight mb-3">
                <div class="p-2 bd-highlight">
                    <form id="form" class="form-inline" method="POST" action="{{ route('manager.pdf.resumen-ingresos-egresos') }}" target="_blank">
...
@endsection
@section('scripts')
    <script src="{{ asset('js/manager/reportes/resumenIngresosEgresos.js') }}"></script>
@endsection
