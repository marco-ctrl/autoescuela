...
<body>
    ...
    <p style="text-align: right; font-size: 12px;">Fecha de impresion:{{ date('d/m/Y H:i:s') }}</p>
    <table class="datos">
        <tr>
            <td colspan="3"><strong>Señor(a):</strong> {{ $informacion->persona ?? 'Sin Asignar' }}</td>
        </tr>
        <tr>
            <td colspan="3"><strong>Fecha Emision:</strong> 
    ...
    <table class="autorizado">
        <tr>
            <th colspan="4">
                ...
                recibi conforme</th>
            <th colspan="3">____________________<br>pagado por</th>
        </tr>
        <tr>
            <td><b>Nombre</b></td>
            <td colspan="3">
                {{ $informacion->persona ?? 'Sin Asignar' }}
            </td>
