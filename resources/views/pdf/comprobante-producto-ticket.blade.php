...
<head>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.location.href = '/public/api/pdf/comprobante-ticket/' + {{$comprobante->cp_codigo}} +'/' + {{ $usuario->us_codigo }} +'/' + contentHeightMm;
        });
    </script>
</head>
...
<body>
    ...
    <main>
        ...
        <div class="datos">
            <p><strong>Señor(a):</strong> {{ $informacion->estudiante }}</p>
    ...
    <footer>
        <div>
            ...
            <p>Nombre: {{ $informacion->estudiante }}</p>
        </div>
