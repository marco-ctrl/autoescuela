...
use App\Http\Controllers\Views\Manager\ServicioController;
use Illuminate\Support\Facades\Route;

Route::get('/home', [HomeController::class, 'index'])->name('manager.home');
Route::get('/servicios', [ServicioController::class, 'index'])->name('manager.registro.servicios.index');
Route::get('/servicios/create', [ServicioController::class, 'create'])->name('manager.registro.servicios.create');
