...
final class UpdateEntregaCertificadoPATCHController extends Controller
{
    public function index(ItProgramacion $programacion): JsonResponse
    {
        try {
            ...
            $programacion->ca_estado = 1;
            $programacion->ca_usuario_entrega = auth()->user()->us_codigo;
            $programacion->ca_fecha_entrega = date('Y-m-d H:i:s');
