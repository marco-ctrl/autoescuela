...
namespace Src\manager\certificado_antecedentes\infrastructure\resources;
...
class ListPagoCuotaResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'servicio' => $this->certificado->ca_descripcion,
            'usuario' => $usuario,
            'costo' => $this->certificado->ca_precio,
            ...
            'cancelado' => $this->certificado->ca_precio - $numero_redondeado,
            'saldo' => $numero_formateado,
            'entregado' => $this->ca_estado,
            'fecha_entrega' => $this->ca_fecha_entrega,
